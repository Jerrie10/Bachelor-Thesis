...
\subsection{Buslines}
Only buslines that travel at least partially through the study area are taken into account for this study. Lines that are not entirely inside the study area are truncated to only have stops within it. The stop were such lines enter or leave the municipality are treated as starting- or ending stops, respectivily. This gives that some lines that differ outside the municipality appear identically in our study.
