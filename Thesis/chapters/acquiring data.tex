\chapter{Acquiring data}\label{sec:acquiringdata}
To run the algorithm, some data needs to be acquired. This secCtion will provide the methodology of how this data was acquired, full tables of data can be found in the appendix.
\section{Busses}
...
\begin{comment}
TODO:
- rewrite refferencing section 2
- note that euclidean disctance is used, where obstacles like large buildings or impassable canals are ignored under the assumption that these are distributed equally across the region
\end{comment}
