...
assignment_fw_epsilon = 1000 # assignment model cutoff epsilon
assignment_fw_change1 = 20 # assignment model flow change cutoff
assignment_fw_change2 = 50 # assignment model waiting change cutoff
assignment_fw_max = 50 # maximum assignment model iterations
